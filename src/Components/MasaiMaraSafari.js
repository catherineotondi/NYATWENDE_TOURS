    ...
    <div className="masaisafari-container">
      ...
      <div className="masaitable-container">
        ...
        <table className="masaisafari-table">
          ...
          <tbody>
            <tr><td><b>Day 1</b></td><td>Nairobi → Masai Mara</td><td>Drive via Rift Valley, lunch, afternoon game drive</td></tr>
            <tr><td><b>Day 2</b></td><td>Masai Mara</td><td>Morning & afternoon game drives, optional Masai Village visit ($25)</td></tr>
            <tr><td><b>Day 3</b></td><td>Masai Mara → Nairobi</td><td>Early breakfast, final game drive, return to Nairobi</td></tr>
          </tbody>
        </table>
      </div>
