// components/LuxuriousLodges.js
import React from 'react';
import "../css/styles.css"; 


const LuxuriousLodges = () => {
  return (
    <div className="blog-container">
      ...
      <p>
        Kenya Highlights Safari – A Luxury Adventure Through the Wild
        <br /><br />
        There’s something extraordinary about waking up to a giraffe outside your window,
        floating over the Masai Mara in a hot air balloon, or soaking in a private pool with
        Mount Kilimanjaro in the distance.
        <br /><br />
        Kenya offers a safari experience like no other—combining breathtaking landscapes, rich
        wildlife, and some of the most stunning luxury lodges in the world. From the vibrant
        city of Nairobi to the vast savannahs of the Masai Mara, the flamingo-filled Lake
        Nakuru, the serene shores of Lake Naivasha, and the breathtaking views of Amboseli,
        here are some of the top luxury lodges that make a Kenyan safari truly unforgettable.
      </p>
      ...
      <p>
        Perched high on the Great Rift Valley, Angama Mara offers breathtaking panoramic views
      ...
      <p>
        Kenya isn’t just about seeing wildlife—it’s about experiencing the magic of the wild in
        the most extraordinary way.
      </p>

      <div className="hashtags">
        #TravelInsights #LuxuryTravel #KenyaSafari
      </div>
    </div>
  );
};

export default LuxuriousLodges;
